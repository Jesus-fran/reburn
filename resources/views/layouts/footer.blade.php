    ...
    <div class="row row-footer">
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <ul class="list-unstyled socila-list">
                ...
                <li><a href="https://web.facebook.com/profile.php?id=100035986544312&_rdc=1&_rdr" target="_blank"><img
                            src="assets/images/social/facebook.png" alt="facebook"></a></li>
                <li><a href="https://twitter.com/ReburnGm" target="_blank"><img src="assets/images/social/twitter.png"
                            alt="twitter"></a></li>
